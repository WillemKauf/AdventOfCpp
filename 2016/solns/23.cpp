...
struct day_23 : public Advent_type {
  ...
  int runInstructs(int aReg) const {
  ...
  std::string part_1() override { return std::to_string(runInstructs(7)); }

  std::string part_2() override { return std::to_string(runInstructs(12)); }
};
