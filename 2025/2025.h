...
struct AOC2025 : AdventYear_type {
  int year() override { return 2025; }
  ...
  void Run() override { RunImpl({1}); }
};

inline AdventYearPtr_type MakeYear() { return std::make_unique<AOC2025>(); }

inline void Run() { MakeYear()->Run(); }

};  // namespace AOC2025

#endif  // #ifndef AOC_2025_H
